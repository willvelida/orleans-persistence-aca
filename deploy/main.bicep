      ...
      containers: [
        {
          ...
          env: [
            ...
            }
            {
              ...
              value: 'DefaultEndpointsProtocol=https;AccountName=${cosmosAccount.name};AccountKey=${listKeys(cosmosAccount.id, cosmosAccount.apiVersion).primaryMasterKey};TableEndpoint=https://${cosmosAccount.name}.table.cosmos.azure.com:443/;'
            }
          ]
        }
      ]
